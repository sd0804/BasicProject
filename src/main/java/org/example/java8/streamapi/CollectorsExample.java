...
/** * * A simple Java Program to demonstrate how to use * collectors to collect the result of Stream in different * collections like List, Set, and Map, and exploring * advanced Collectors options like gropuingBy * and partitionBy */
 class Hello
{
...
//         int minimum = summary.getMin(); System.out.println("original list: " + numbers);
